...
{/* Telegram */}
<a href="https://t.me/Rustamovv_E" className="bg-white/10 hover:bg-[#229ED9] p-6 rounded-2xl transition-all">
...
{/* Instagram */}
<a href="https://instagram.com/rustamovv.09" className="bg-white/10 hover:bg-pink-600 p-6 rounded-2xl transition-all">
<div className="text-2xl mb-2">📸</div>
