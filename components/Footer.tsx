...
export default function Footer() {
  return (
    <footer className="w-full bg-white/80 backdrop-blur-xl border-t border-zinc-100 py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 items-start">
          ...
          {/* 2. MENYU (Sening videongdagi tartibda) */}
          <div className="flex flex-col gap-4">
            <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-zinc-400">Menyu</h4>
            <nav className="flex flex-col gap-3">
              {['Bosh sahifa', 'Avtomobillar', 'Biz haqimizda', 'Kontakt'].map((item) => (
                <Link key={item} href="#" className="text-sm font-bold text-zinc-900 hover:text-red-600 transition-colors w-fit">
                  {item}
                </Link>
              ))}
            </nav>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              {/* TELEGRAM ORIGINAL SVG */}
              <a href="https://t.me/Rustamovv_E" className="p-3 rounded-xl bg-zinc-100 text-zinc-600 hover:bg-[#229ED9] hover:text-white transition-all duration-300 group">
              ...
              {/* INSTAGRAM ORIGINAL SVG */}
              <a href="https://www.instagram.com/rustamovv.09?igsh=b3o1aWpyZzNvMG04" className="p-3 rounded-xl bg-zinc-100 text-zinc-600 hover:bg-gradient-to-tr hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7] hover:text-white transition-all duration-300">
                <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
        ...
        <div className="mt-16 pt-8 border-t border-zinc-100 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-zinc-400 text-[11px] font-bold uppercase tracking-widest">
            © 2026 AvtoBozor. Barcha huquqlar himoyalangan.
          </p>
          <div className="flex gap-6 text-[10px] font-black uppercase tracking-widest text-zinc-400">
            <a href="#" className="hover:text-red-600 transition-colors">Maxfiylik siyosati</a>
            <a href="#" className="hover:text-red-600 transition-colors">Foydalanish shartlari</a>
          </div>
        </div>
      </div>
    </footer>
